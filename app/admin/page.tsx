...
export default function AdminPage() {
  const metrics = [
    { title: "Total proyectos", value: adminModules.proyectos.records.length, description: "Iniciativas locales documentadas", icon: Lightbulb },
    { title: "Total historias", value: adminModules.historias.records.length, description: "Crónicas y piezas editoriales", icon: Newspaper },
    { title: "Total episodios", value: adminModules.podcast.records.length, description: "Conversaciones del podcast", icon: Headphones },
    { title: "Total eventos", value: adminModules.eventos.records.length, description: "Actividades en agenda", icon: CalendarDays },
    ...
    { title: "Oportunidades activas", value: adminModules.oportunidades.records.filter((item) => item.status === "Activa").length, description: "Publicaciones visibles", icon: ClipboardList }
  ];
