...
export default async function MapaPage() { const projects = await getProjects(); return <section className="mx-auto max-w-7xl px-4 py-16"><SectionTitle eyebrow="Mapa interactivo" title="Mapa de lo Hecho en La Dorada" description="Emprendimientos, eventos, lugares turísticos, espacios culturales, fundaciones, organizaciones, parques, bibliotecas y museos filtrables por categoría." /><MapView projects={projects} /></section>; }
